...
$RepoUrl = "https://github.com/shaver3josiah/Calculator.git"
$ActionsUrl = "https://github.com/shaver3josiah/Calculator/actions"
...
if ($pending) {
    git commit -m "Bloom iOS port: BloomCore engines (290 golden vectors), SwiftUI app, no-Mac CI to TestFlight" | Out-Null
...
Write-Host ""
Write-Host "Pushed. The 'test' workflow is now compiling BloomCore and running all 290 golden vectors on Linux." -ForegroundColor Green

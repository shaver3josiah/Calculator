...
if (-not (Get-Command git -ErrorAction SilentlyContinue)) {
    Write-Host "Git is not installed. Run 1-Push-Bloom.ps1 first." -ForegroundColor Red
    exit 1
}
...
Write-Host "  1. Apple: bundle id com.shaver.bloomcalculator registered, app record created, agreements accepted"
Write-Host "  2. Hannah added as internal tester"

...
struct ReturnsChart: View {
    ...
    private let entries: [ReturnEntry] = [
        ...
        ReturnEntry(name: "Top growth fund", subtitle: "a strong large-cap / tech fund", pct: 15, tone: .bloom),
    ...
    private func color(for tone: ReturnTone) -> Color {
        ...
        case .bloom: return themeStore.color("primary")          // pink accent
        case .deep: return themeStore.color("primaryStrong")     // strong pink accent
...
enum ReturnTone {
    case benchmark, bloom, deep, gold
}

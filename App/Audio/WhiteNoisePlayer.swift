...
/// Gentle looping white-noise player for the flower's hidden "calm" hold gesture.
...
final class WhiteNoisePlayer: @unchecked Sendable {
    ...
    /// Drives the flower's subtle "active" cue. Observed by SwiftUI; mutate on main.
    ...
    private let logger = Logger(subsystem: "com.shaver.bloomcalculator", category: "WhiteNoisePlayer")
